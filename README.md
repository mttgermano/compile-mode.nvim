...
return {
    ...
    config = function()
        ...
        vim.g.compile_mode = {
            ...
            -- to make the compilation buffer not appear in the tab list
            -- hidden_buffer = true,

            -- to make the cursor focus on the compilation buffer 
            -- focus_compilation_buffer = true,

            -- to make the cursor go to the beginning of the compilation log, at the compilation buffer
            -- focus_beginning_compilation_buffer=true,

            -- reset que compilation buffer lenght (buffer panel max size)
